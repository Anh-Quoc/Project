...
//        }
    ...
    private void setCalculationToTextView(){
        DatabaseHandler db = new DatabaseHandler(this);
        ArrayList<Calculation> listCalculation = new ArrayList<>(db.getAllCalculation());
        int indexTextView = 1;
        for(Calculation calculation : listCalculation){
            if(indexTextView < listIDTextView.get)
        }
    }
